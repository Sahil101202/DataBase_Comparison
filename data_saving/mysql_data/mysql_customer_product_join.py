    ...
    with open(json_file) as file:
        ...
        for row in data:
            ...
            for product in products:
                ...
                sql = f"INSERT INTO {table_name} (customer_id, product_id, customer_name, product_name) VALUES (%s, %s, %s, %s)"
                # Modify the above query to include more columns

                # Execute the query with the data
                cursor.execute(sql, (column1_value, column3_value, column2_value, column4_value))
