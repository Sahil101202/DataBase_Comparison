...
json_file = '/Users/sahil/Desktop/db_project/datasets/dataset(1000000)/products(1M).json'
...
try:
    ...
    with open(json_file) as file:
        ...
        for row in data:
            ...
            sql = f"INSERT INTO {table_name} (id, name, brand, price, quantity) VALUES (%s, %s, %s, %s, %s)"
            # Modify the above query to include more columns

            # Execute the query with the data
            cursor.execute(sql, (column1_value, column2_value, column3_value, column4_value, column5_value))
