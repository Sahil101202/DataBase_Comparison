...
try:
    ...
    for i in range(n):
        ...
        data = neo4j_session.run("MATCH (c:Customer)-[:PURCHASED]->(p:Product) RETURN c.id, c.first_name, c.email, c.phone_number, p.name, p.brand, p.price")
    ...
    file_path_first_time = '/Users/sahil/Desktop/db_project/times_from_query/neo4j/0_25/cp_join_first_time.json'
    file_path_times = '/Users/sahil/Desktop/db_project/times_from_query/neo4j/_025/cp_join_times.json'
